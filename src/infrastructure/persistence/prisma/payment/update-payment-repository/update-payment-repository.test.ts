...
import { PrismaUpdatePaymentRepository } from "./update-payment-repository"
...
describe("PrismaUpdatePaymentRepository", () => {
    let repository: PrismaUpdatePaymentRepository
    let now: Date

    beforeEach(() => {
        repository = new PrismaUpdatePaymentRepository()
        now = new Date()
        vi.clearAllMocks()
    })
